...
class BILSTM_CNN(nn.Module):
    ...
    def __init__(self, embedding_dim, hidden_dim, vocab_size, tagset_size, char_size, pretrained_weight_embeddings, USE_CRF=False,
    ...
    def forward(self, sentence, chars, bigram_one_hot=None):
