...
with open('../data/duolingo/es_en_train_allfeats_lowered.pkl', 'wb') as f:
    pickle.dump(X, f)

with open('../data/duolingo/es_en_train_labels.pkl', 'wb') as f:
    pickle.dump(Y, f)
...
with open(DATA_PATH + 'es_en.slam.20171218.dev', 'r') as f_data:
    with open(DATA_PATH + 'es_en.slam.20171218.dev.key', 'r') as f_labels:
        sent = {'words':[], 'pos':[], 'edge_labels':[], 'edge_heads':[], 'chars':[]}
        y=[]
        for line in f_data:
            tokens = line.split()
...
with open('../data/duolingo/es_en_dev_allfeats_lowered.pkl', 'wb') as f:
    pickle.dump(X, f)

with open('../data/duolingo/es_en_dev_labels.pkl', 'wb') as f:
    pickle.dump(Y, f)
